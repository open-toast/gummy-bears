...
[Animal Sniffer](https://www.mojohaus.org/animal-sniffer/) provides tools to assert your project's binary compatibility with a specific version of a library. We use Animal Sniffer to ensure that libraries consumed by toastmobile do not use any APIs unavailable on Android 4.4.
